<?php
// ============================================================
//  index.php  —  Portofolio Dinamis
//  Profile   : hardcoded (tidak dari database)
//  Experience, Skills, Certificates : dari database MySQL
// ============================================================
                ...
                <div class="cert-card">
                    <div class="cert-photo-wrap">
                        <?php if (!empty($cert['photo'])): ?>
                            <img src="<?= htmlspecialchars($cert['photo']) ?>"
